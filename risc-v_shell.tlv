...
\TLV
   ...
   $is_u_instr = $instr[6:2] ==? 5'b0x101; // Done 
   $is_s_instr = $instr[6:2] ==? 5'b0100x; // Done
   $is_i_instr = $instr[6:2] == 5'b0000x || $instr[6:2] == 5'b001x0 || $instr[6:2] == 5'b11001; // Done
   $is_r_instr = $instr[6:2] == 5'b01011 || $instr[6:2] == 5'b01100 || $instr[6:2] == 5'b01110 || $instr[6:2] == 5'b10100;
   $is_j_instr = $instr[6:2] == 5'b11011; // Done
   $is_b_instr = $instr[6:2] == 5'b11000; // Done
   ...
   $result[31:0] = $is_addi ? $imm + $src1_value :
                   $is_add  ? $src1_value + $src2_value :
                   32'b0;

   // Stop compiler warnings
   `BOGUS_USE($rd $rd_valid $rs1 $rs1_valid $func3 $imm_valid $opcode $rs2 $rs2_valid $imm)
